...
grand_parent: "Canadian Intellectual Property Office (CIPO) Patent PostgreSQL Database"
---
...
3. Once your script has been uploaded, connect to Trillium [as described earlier](https://mdlutoronto.github.io/cipo-mac/1.1-access-the-high-performance-computing-environment/)
...
9. It may take a while to run, but when it is finished you will see the command prompt again, and now if type `ls` from the Trillium prompt, you should see a new CSV file created from the Python script. Download the file ([as described earlier](https://mdlutoronto.github.io/cipo-mac/1.3-download-the-results/)) and open up the file to see the results
