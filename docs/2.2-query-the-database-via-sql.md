...
1. Once logged in [as described earlier](https://mdlutoronto.github.io/cipo-mac/2.1-access-the-high-performance-computing-environment/), at the prompt, type `module load postgresql` (and press Enter after this and any commands you type into the command prompt going forward)
